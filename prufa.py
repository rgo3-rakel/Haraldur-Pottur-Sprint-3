...
class Level:
    ...
    #Búa til breytu sem heitir Victory = False í sprett 3
    def __init__(self):
        pass

    def beginning(self):
        print("Velkomin/nn í leikinn svaðilfari!")
        #setja mynd inn, #Dumbledore talar
        time.sleep(1)
        level1 = Level1()
        level1.startLevel()
...
class Level1(Level):
    ...
    def createCharacter(self):
        ...
        if choice == 'já' :
            ...
            if confirm == 'já':
                print("Ertu tilbúin/nn? Nú hefst ferð á vit ævintýranna. \nGakktu nú um borð í lestina sem er við lestarpall 9 3/4 sem flytur þig í galdraskólann Hogwarts!!!")
            elif confirm == 'nei':
                self.createCharacter()
        elif choice == 'nei':
            sys.exit()
