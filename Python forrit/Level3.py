class Level3(Level):
    ...
    def questionGame(self, character):
        level4 = Level4()
        ...
        if prof == '4':
            ...
            if val == '1' or val == '2' or val == '3':
                print("Nú ert þú í klófestu Lávarðs Valdimars og er " + character.getName() + " hér með rekin/nn úr Hogwarts!!")
                time.sleep(6)
                sys.exit()
            if val == '4':
                print("Hárrétt " + character.getName() + "!!\n")
                ...
                if val == '4':
                    ...
                    if val == '4':
                        ...
                        if val == '1' or val == '2' or val == '4':
                            print("Nú ert þú í klófestu Lávarðs Valdimars og er " + character.getName() + " hér með gerður brottrækur úr Hogwarts!!")
                            time.sleep(6)
                            sys.exit()
                        if val == '3':
                            print("Hárrétt " + character.getName() + "!!\n")
